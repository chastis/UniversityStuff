...
public class ControlPanel extends Frame 
{
  ...
  public void init( Kernel useKernel , String commands , String config ) 
  {
    ...
    statusValueLabel.reshape( 345,(++num)*15+25,100,15 );
    add( statusValueLabel );

    timeValueLabel.reshape( 345,(++num)*15+25,100,15 );
    add( timeValueLabel );

    instructionValueLabel.reshape( 385,(++num)*15+25,100,15 );
    add( instructionValueLabel );

    addressValueLabel.reshape(385,(++num)*15+25,230,15);
    add( addressValueLabel );

    pageFaultValueLabel.reshape( 385,(++num)*15+25,100,15 );
    add( pageFaultValueLabel );

    virtualPageValueLabel.reshape( 395,(++num)*15+25,200,15 );
    add( virtualPageValueLabel );

    physicalPageValueLabel.reshape( 395,(++num)*15+25,200,15 );
    add( physicalPageValueLabel );

    RValueLabel.reshape( 395,(++num)*15+25,200,15 );
    add( RValueLabel );

    MValueLabel.reshape( 395,(++num)*15+25,200,15 );
    add( MValueLabel );

    inMemTimeValueLabel.reshape(395,(++num)*15+25,200,15 );
    add( inMemTimeValueLabel );

    lastTouchTimeValueLabel.reshape( 395,(++num)*15+25,200,15 );
    add( lastTouchTimeValueLabel );

    lowValueLabel.reshape( 395,(++num)*15+25,230,15 );
    add( lowValueLabel );

    highValueLabel.reshape( 395,(++num)*15+25,230,15 );
    add( highValueLabel );

    Label virtualOneLabel = new Label( "virtual" , Label.CENTER) ;
    virtualOneLabel.reshape(0,30+25,70,15);
    add(virtualOneLabel);

    Label virtualTwoLabel = new Label( "virtual" , Label.CENTER) ;
    virtualTwoLabel.reshape(140,30+25,70,15);
    add(virtualTwoLabel);

    Label physicalOneLabel = new Label( "physical" , Label.CENTER) ;
    physicalOneLabel.reshape(70,30+25,70,15);
    add(physicalOneLabel);

    Label physicalTwoLabel = new Label( "physical" , Label.CENTER) ;
    physicalTwoLabel.reshape(210,30+25,70,15);
    add(physicalTwoLabel);

    Label statusLabel = new Label("status: " , Label.LEFT) ;
    statusLabel.reshape(285,15+25,65,15);
    add(statusLabel);

    Label timeLabel = new Label("time: " , Label.LEFT) ;
    timeLabel.reshape(285,30+25,50,15);
    add(timeLabel);
